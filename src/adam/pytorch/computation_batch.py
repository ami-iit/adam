...
class KinDynComputationsBatch:
    ...
    def __init__(
        ...
        gravity: jnp.array = jnp.array([0, 0, -9.80665, 0, 0, 0]),
    ) -> None:
        """
        Args:
    ...
    def from_urdf(
        ...
        """Initializes the class using a URDF string

        Args:
            urdf_string (Union[str, Path]): The URDF path or string
            joints_name_list (list, optional): The list of actuated joints. Defaults to None.
            gravity (np.array, optional): The gravity vector. Defaults to jnp.array([0, 0, -9.80665, 0, 0, 0]).

        Returns:
            KinDynComputationsBatch: The class instance
        """
        return KinDynComputationsBatch(
    ...
    def from_mujoco_xml(
        ...
        """Initializes the class using a Mujoco XML string
