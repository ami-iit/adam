...
from adam.core.array_api_math import ArrayAPISpatialMath, ArrayAPIFactory, ArrayAPILike
...
class TorchLikeFactory(ArrayAPIFactory):
    ...
    def __init__(self):
        ...
        super().__init__(TorchLike, torch)
    ...
    # @staticmethod
    # def asarray(x: ntp.ArrayLike) -> "TorchLike":
    #     """
    #     Returns:
